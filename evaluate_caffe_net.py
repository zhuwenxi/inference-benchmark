...
if args.model_type == 'alexnet' or args.model_type == 'caffenet':
    ...
    def forward(x, t):
        ...
        return F.softmax_cross_entropy(y, t), F.accuracy(y, t), np.argpartition(y.data[0], -5)[-5:]
...
for path, label in dataset:
    ...
    if i == args.batchsize:
        ...
        loss, accuracy, top5 = forward(x, t)

        print(label.shape, top5.shape)
...
print('mean loss:     {}'.format(accum_loss / my_iter))
print('mean accuracy: {}'.format(accum_accuracy / my_iter))
print('top5: {}'.format(accum_top5 / my_iter))
